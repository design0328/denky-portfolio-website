...
export const projects = [
  ...
  },
  {
    ...
    thumbnail:  `${BASE}/screenshots/admin-settings/04-left-nav-a11y-overview.png`,
    ...
    heroImage:  `${BASE}/screenshots/admin-settings/04-left-nav-a11y-overview.png`,
  ...
  },
  {
    ...
    sections: [
      ...
      { type: 'imageGrid', images: [{ src: '/denky-portfolio-website/screenshots/ringlead/era3-hero.png', alt: 'RingLead website hero section promoting Data Orchestration, RevOps Automation, and Technology Consolidation', caption: 'The rebranded website hero — Data Orchestration, RevOps Automation, Technology Consolidation' }, { src: '/denky-portfolio-website/screenshots/ringlead/era3-design-system.png', alt: 'RingLead design system component library in Sketch, showing buttons, color tokens, and typography scale', caption: 'The Sketch design system — color tokens, typography, and a complete component library' }, { src: '/denky-portfolio-website/screenshots/ringlead/era3-product-ui.png', alt: 'RingLead product UI screens including dashboard, roles and administration, and Salesforce connections', caption: 'Product UI redesign — dashboard, admin, and connections screens rebuilt on the new system' }] },
