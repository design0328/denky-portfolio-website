...
export const projects = [
  ...
  },
  {
    ...
    role: 'UX/UI Designer II — Design Systems & Accessibility',
  ...
  },
  {
    ...
    year: '2016–2021',
    role: 'Senior Graphic Designer → UX/UI Designer (Sole Designer)',
    ...
    thumbnail: '/denky-portfolio-website/screenshots/ringlead/phoenix-logo.png',
    sections: [
  ...
  },
  {
    ...
    eyebrow: 'DESIGN SYSTEM MIGRATION · ANGULAR TO REACT',
    discipline: 'Design Systems',
    year: '2024–2025',
    company: 'ZoomInfo',
    role: 'UX/UI Designer II — Design Systems & Accessibility',
    desc: 'When ZoomInfo moved from its Angular Material–based design system to MUI React, I helped map the path — component equivalences, migration documentation, and keeping the team oriented across two systems at once.',
    tags: ['Design Systems', 'MUI', 'Migration', 'Documentation', 'DesignOps'],
    thumbnail: '/denky-portfolio-website/screenshots/design-system/01-a11y-guidelines-keyboard.png',
    chips: [
      { label: 'Design Systems', accent: 'cyan' },
      { label: 'Migration' },
    ...
    overview: 'When leadership decided to move new product builds from Muze — ZoomInfo\'s Angular Material–based component library — to MUI React, the team was suddenly dual-track: maintain Muze for all native products while ramping up on an entirely new system. I had context no one else on the team had — I\'d introduced MUI at RingLead years earlier and taught myself the system from scratch. I used that experience to help map component equivalences, communicate what changed, and document how the team should move forward. The AIUI Pattern Library started here — as the governance layer for AI-ready components in the new system.',
    caseStudySections: [
      {
        type: 'text',
        heading: 'The Transition',
        body: 'Muze wasn\'t going away — it still supported every native ZoomInfo product. But new builds were moving to MUI React, and designers needed to know which components mapped to what, what behavior changed, and where to start. I documented the component equivalences, updated Storybook with MUI component documentation, and ran the open hours sessions that gave the team a live space to ask questions across both systems.',
      },
      {
        type: 'imagePair',
        images: [
          {
            src: '/denky-portfolio-website/screenshots/design-system/07-transition-accordion-note.png',
            alt: 'AdminPortal Websights screen with annotation note: Accordion component will not be supported by CI, but instead the dev team assigned to project will maintain and share once completed with Muze.',
            caption: 'Component-level transition decisions documented at the point of handoff — what Muze sustains vs. what MUI takes over.',
          },
          {
            src: '/denky-portfolio-website/screenshots/design-system/08-transition-profile-storybook.png',
            alt: 'Sales+ Profile page showing component analysis: current accordion Storybook component is legacy, new proposed interaction, design was proposed in Muze open hours then built as component in Storybook.',
            caption: 'Muze Open Hours → Storybook pipeline — proposals surfaced in sessions became documented components in the new system.',
          },
        ],
      },
      {
        type: 'text',
        heading: 'The AIUI Foundation',
        body: 'As MUI came in, the product roadmap was simultaneously accelerating toward AI features. The two transitions happened at the same time — a new component library and a new class of AI-driven interactions, both at once. The AIUI Pattern Library started as the answer: a governance layer documenting how to use MUI components in AI contexts, what new patterns AI features required, and how to build consistently across a team that was still learning the system. It was foundational work — the beginning of a new design system, not the end of one.',
      },
      {
        type: 'imagePair',
        images: [
          {
            src: '/denky-portfolio-website/screenshots/design-system/09-mini-muze-figma-library.png',
            alt: 'OperationsOS Mini Muze Figma file showing the product-specific component library structure across seven product surfaces.',
            caption: 'The system being maintained — Mini Muze product libraries built on Muze core, still active while MUI ramped.',
          },
          {
            src: '/denky-portfolio-website/screenshots/design-system/03-a11y-nav-workflows.png',
            alt: 'Left Navigation accessibility annotation showing Ready for Dev status — Muze component work continuing in parallel with MUI adoption.',
            caption: 'Muze work continued in parallel — accessibility annotation and dev handoff didn\'t stop while the migration ramped.',
          },
        ],
      },
      {
        ...
        body: 'I\'d been through this before. At RingLead I\'d introduced MUI to the engineering team and built the component practice from nothing. That context meant I could speak to both the design system team and the engineers in language that made sense — what changes between Angular Material and React, what stays the same, what to watch for. The migration was still in progress when my role ended. The documentation, the open hours format, and the AIUI foundation were built to outlast any one person\'s involvement.',
      },
    ],
  },
  {
